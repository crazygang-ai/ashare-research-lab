...
ROLE_BY_KIND_AND_KEY: dict[str, dict[str, str]] = {
    ...
    "daily_report": {
        "markdown": "markdown_report",
        "daily_candidates": "daily_candidates_csv",
        "daily_score_summary": "daily_score_summary_csv",
        "daily_factor_contributions": "daily_factor_contributions_csv",
        "daily_risk_summary": "daily_risk_summary_csv",
        "daily_changes": "daily_changes_csv",
        "daily_factor_validation_summary": "daily_factor_validation_summary_csv",
        "daily_backtest_summary": "daily_backtest_summary_csv",
        "daily_event_study_summary": "daily_event_study_summary_csv",
        "daily_input_artifacts": "daily_input_artifacts_json",
        "daily_metadata": "daily_metadata_json",
    },
    "stock_report": {
        "markdown": "markdown_report",
        "stock_factor_values": "stock_factor_values_csv",
        "stock_score_breakdown": "stock_score_breakdown_csv",
        "stock_risk_flags": "stock_risk_flags_csv",
        "stock_recent_announcements": "stock_recent_announcements_csv",
        "stock_metadata": "stock_metadata_json",
    },
    "data_quality_gate": {
        "csv": "gate_csv",
        "json": "gate_json",
